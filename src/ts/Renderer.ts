  ...
  private draw(render: RenderType): void {
    ...
    if(render.method === 'image' && render.properties.image) {
      this.state.ctx.drawImage(
        render.properties.image.image || new Image(),
        0,
        0,
        31,
        46,
        render.properties.image.x + (render.properties.image.width / 4),
        render.properties.image.y,
        render.properties.image.width,
        render.properties.image.height
     );
